...
Reino Unido, Austrália e Nova Zelândia, \citeonline{agunegreg}. Apesar da recente existência de dados abertos governamentais,
...
servidores públicos, onde poderão utilizar dados públicos de forma colaborativa para ações de cidadania, \citeonline{wsproposicoes}.
